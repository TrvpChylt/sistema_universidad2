...
<body style="background: linear-gradient(135deg, #000C40 0%, #003973 50%, #E5E5BE 100%) !important; background-attachment: fixed !important;" class="min-h-screen flex flex-col justify-between font-sans antialiased text-slate-100">
